...
class AuthInterceptor extends Interceptor {
  ...
  onRequest(RequestOptions options) {
    String accessToken = "";
//    SpUtil.getString(Constants.accessToken);
    if (accessToken.isNotEmpty) {
      options.extra["token"] = "$accessToken";
    } else {
      options.extra["token"] = "9ee514d1055a36c58bb86c0fdb3d82f9fd15s2sq";
    }
...
class AdapterInterceptor extends Interceptor {
  ...
  static const String message = "meg";

  static const String defaultText = "\"无返回信息\"";
  static const String notFound = "未找到查询信息";

  static const String failureFormat = "{\"code\":%d,\"msg\":\"%s\"}";
  static const String successFormat = "{\"code\":1,\"msg\":\"\",\"data\":%s}";
